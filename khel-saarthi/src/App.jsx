...
//   /**
//    * Ensures that the pose landmarker model is loaded.
//    * If the pose mode is set to "off", this function will return false.
//    * If the pose model is already loaded, this function will return true.
//    * If the pose model is not loaded, this function will attempt to load it.
//    * If the loading fails, this function will return false and log a warning.
//    * @returns {Promise<boolean>} A promise that resolves to true if the pose model is loaded, and false otherwise.
//    */
...
//       // If the pose mode is set to "local", load the model from the local files.
//       // Otherwise, load the model from the CDN.
//       if (POSE_MODE === "local") {
...
//       return true;
//     } catch (e) {
//       // If the loading fails, log a warning and return false.
